...
public class InsumoDto
{
    ...
    /// <summary>
    /// Cria uma cópia superficial (shallow copy) da instância atual do InsumoDto.
    /// Este método é útil para preservar o estado original do DTO em operações de edição.
    /// </summary>
    /// <returns>Uma nova instância de InsumoDto com os mesmos valores de propriedade.</returns>
    public InsumoDto Clone()
    {
        ...
        return (InsumoDto)this.MemberwiseClone();
    }
